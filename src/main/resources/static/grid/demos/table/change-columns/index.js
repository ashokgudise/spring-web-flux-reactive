...
window.onload = function () {
    const table = document.getElementById('table'), add = document.getElementById('add'), remove = document.getElementById('remove'), shuffle = document.getElementById('shuffle');
