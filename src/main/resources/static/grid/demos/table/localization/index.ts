    ...
    get properties() {
        return {
            ...
            columns: [
                ...
                {
                    label: 'Име', dataField: 'name', dataType: 'string', transform: function (value: string) {
                ...
                {
                    label: 'Изобилие', dataField: 'abundance', dataType: 'number', formatFunction(settings: { value: any, row: string | number, column: string, cell: HTMLTableCellElement, template?: any }) {
