...
window.Smart('#table', class {
    get properties() {
        return {
            ...
            sortMode: 'one',
            columns: [
                { label: 'תעודת זהות', dataField: 'id', dataType: 'number' },
                { label: 'שם מוצר', dataField: 'productName', dataType: 'string' },
                { label: 'כמות', dataField: 'quantity', dataType: 'number' },
                { label: 'מחיר', dataField: 'price', dataType: 'number' },
                { label: 'תאריך רכישה', dataField: 'date', dataType: 'date' }
            ]
        };
    }
});
