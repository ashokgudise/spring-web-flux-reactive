        ...
        return {
            dataSource: new window.Smart.DataAdapter({
                virtualDataSourceOnExpand: function (resultCallbackFunction: any, details: any) {
                    const result = (window.demoServer as any).getData(details);
                ...
                virtualDataSource: function (resultCallbackFunction: any, details: any) {
                    if (details.action === 'dataBind') {
                        ...
                        window.data = (window.demoServer as any).executeQuery('SELECT * FROM Employees') as any;
...
function DemoServer() {
    ...
    return {
        ...
        getData: function (request: any): any {
