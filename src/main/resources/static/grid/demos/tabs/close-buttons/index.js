...
window.onload = function () {
    ...
    document.getElementById('toggleCloseButtons').addEventListener('change', function (event) {
        tabs1.closeButtons = event.target.checked;
    });
    const showCloseButton = document.getElementById('showCloseButton'), hideCloseButton = document.getElementById('hideCloseButton');
