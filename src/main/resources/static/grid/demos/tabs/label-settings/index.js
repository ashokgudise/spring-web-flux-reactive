...
window.onload = function () {
    const tabs = document.getElementById('tabs'), script = document.createElement('script'), initialized = [false, false, false, true], mapCoordinates = [{ lat: 40.7590403, long: -74.0392705 }, { lat: 22.257983, long: 114.1696828 }, { lat: 42.8863169, long: 24.7089964 }];
